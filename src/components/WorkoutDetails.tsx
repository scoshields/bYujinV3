...
import { Trash2, Plus, Video, FileDown } from 'lucide-react';
              ...
              <div className="flex flex-wrap items-center gap-2 text-sm">
                ...
                {exercise.exercise.video_link && (
                  <a
                    ...
                    className="inline-flex items-center gap-1 px-2 py-1 text-sm font-medium text-indigo-600 hover:text-indigo-800 bg-indigo-50 rounded-md hover:bg-indigo-100 transition-colors whitespace-nowrap"
                  >
                ...
                <button
                  ...
                  className="inline-flex items-center gap-1 px-2 py-1 text-sm font-medium text-gray-600 hover:text-gray-800 bg-gray-50 rounded-md hover:bg-gray-100 transition-colors disabled:opacity-50 whitespace-nowrap"
                >
                    ...
                    <tr key={set.id} className="border-t">
                      ...
                      <td className="py-2 sm:py-3 px-1 sm:px-4">
                        <input
                          ...
                          className="w-16 sm:w-24 px-2 sm:px-3 py-1 border rounded-md shadow-sm focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 bg-white text-gray-900"
                          placeholder="Weight"
                          min="0"
                          step="2.5"
                        />
                      ...
                      <td className="py-2 sm:py-3 px-1 sm:px-4">
                        <input
                          ...
                          className="w-12 sm:w-20 px-2 sm:px-3 py-1 border rounded-md shadow-sm focus:ring-1 focus:ring-indigo-500 focus:border-indigo-500 bg-white text-gray-900"
                          placeholder="Reps"
                          min="0"
                        />
                      </td>
