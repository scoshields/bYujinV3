  ...
  if (mode === 'select') {
    return (
      <div className="max-w-4xl mx-auto">
        <h1 className="text-2xl font-bold mb-8">Generate a Workout</h1>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          ...
          >
            <div className="flex items-center space-x-4 mb-4">
              ...
              <h2 className="text-xl font-semibold">Guided Approach</h2>
            </div>
          ...
          <button
            disabled
            className="p-6 bg-white rounded-lg shadow-md opacity-50 cursor-not-allowed text-left"
          >
            <div className="flex items-center space-x-4 mb-4">
              <div className="p-3 bg-indigo-100 rounded-lg">
                <Brain className="h-6 w-6 text-indigo-600" />
              </div>
              <h2 className="text-xl font-semibold">Expert Mode</h2>
            </div>
            <p className="text-gray-600">
                  ...
                  <div key={exerciseIndex} className="border-b pb-4 last:border-b-0">
                    <div className="flex justify-between items-start">
                      ...
                      <div className="text-right">
                        <p className="font-medium">{exercise.sets} sets × {exercise.reps} reps</p>
                        <p className="text-sm text-gray-500">{exercise.primary_equipment}</p>
                      </div>
                    </div>
                  </div>
                ))}
